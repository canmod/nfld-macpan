...
Relative presymptomatic transmission (or contact) `r params["Cp"]`

relative mildly symptomatic transmission (or contact) `r params["Cm"]`

relative severely symptomatic transmission (or contact) `r params["Cs"]`

Fraction of cases asymptomatic `r params["alpha"]`

Time in exposed class `r 1/params["sigma"]` days

Time for asymptomatic recovery `r 1/params["gamma_a"]` days

Time for mildly symptomatic recovery `r 1/params["gamma_m"]` days

Time for severely symptomatic transition to hospital/death `r 1/params["gamma_s"]` days

Time in pre-symptomatic class `r 1/params["gamma_p"]` days

Time in hospital (acute care) `r 1/params["rho"]` days

Population size `r params["N"]`

Fraction of ICU cases dying `r params["phi2"]`

Time in ICU to back to acute care `r 1/params["psi1"]`

Time in ICU to death `r 1/params["psi2"]`

Time post-ICU to discharge `r 1/params["psi3"]`

Fraction of incidence reported as positive tests `r params["c_prop"]`

Average delay between incidence and test report `r params["c_delay_mean"]`

Coefficient of variation of testing delay `r params["c_delay_cv"]`
